...
import { LayoutDashboard, Users, BookOpen, Mic, Sparkles, GraduationCap, CalendarCheck, FileBarChart, FileText, ClipboardCheck, AlertTriangle, Settings, LogOut, Menu } from "lucide-react";
...
const NAV = [
  ...
  { to: "/pelanggaran", icon: AlertTriangle, label: "Pelanggaran" },
  { to: "/rapot", icon: ClipboardCheck, label: "Rapot & Rekap" },
